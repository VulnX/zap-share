  ...
  return (
    ...
    bg-gray-200 w-[40vh] h-[40vh] rounded-full || flex items-center justify-center
     ...
     border-4 ${isTheme ? " border-gray-300" : " border-light-choiceBorder"}`}
          ...
          <div
            className={`recieve clickable ||  bg-gray-200 w-[40vh] h-[40vh] rounded-full || flex items-center justify-center ${isTheme ? " bg-gray-700" : " bg-light-choiceBg"} 
 border-4  ${isTheme ? " border-gray-300" : " border-light-choiceBorder"}`}
        ...
        <div
          className={`h-[5vh] ${isTheme ? " bg-dark-footer" : " bg-light-footer"}`}
        ></div>
      </div>
    </div>
  );
