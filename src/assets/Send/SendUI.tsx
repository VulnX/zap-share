        ...
        <div className={`min-h-screen flex flex-col  ${isTheme ? 'bg-dark-background' : 'bg-light-background'}`}>
            ...
            {qrCode ? (
                ...
                <div className="mt-[10vh] min-w-screen flex justify-center items-center">
                    <div className={`h-[60vh] w-[40vw] flex flex-col justify-center items-center ${isTheme ? 'bg-dark-filepicker' : 'bg-light-filepicker'} rounded-[10vh] drop-shadow-xl shadow-xl`} onClick={openFileSelector}>
