        ...
        <div className={`min-h-screen flex flex-col  ${isTheme ? 'bg-zinc-900' : 'bg-neutral-300'}`}>
            ...
            {qrCode ? (
                ...
                <div className="mt-[10vh] min-w-screen flex justify-center items-center">
                    <div className={`h-[60vh] w-[40vw] flex flex-col justify-center items-center ${isTheme ? 'bg-zinc-400' : 'bg-neutral-200'} rounded-[10vh] drop-shadow-xl shadow-xl`} onClick={openFileSelector}>
                        <div className={`border-[1px] border-dashed ${isTheme ? `border-black` : `border-zinc-700`} rounded-[8vh] w-[35vw] h-[50vh] flex flex-col items-center`}>
